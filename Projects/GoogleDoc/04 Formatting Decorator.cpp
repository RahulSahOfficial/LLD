...
class TextFormattingDecorator:public TextElement{
    public:
    TextElement *el;
    TextFormattingDecorator(TextElement *el):TextElement(""){
        this->el=el;
    }
};
class Bold:public TextFormattingDecorator{
    public:
    Bold(TextElement *el):TextFormattingDecorator(el){}
    string render(){
        return "<b>"+el->render()+"</b>";
    }
};
class Italics:public TextFormattingDecorator{
    public:
    Italics(TextElement *el):TextFormattingDecorator(el){}
    string render(){
        return "<i>"+el->render()+"</i>";
    }
};
...
int main(){
    ...
    editor->addNewLine();
    editor->addElement(new Bold(new TextElement("I am Bold")));
    editor->addNewLine();
    editor->addElement(new Italics(new TextElement("I am Italics")));
    editor->addNewLine();
